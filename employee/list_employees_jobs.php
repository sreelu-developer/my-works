...
DATE_FORMAT(wk_panchayathdate,'%d/%M/%Y' ) AS `wk_panchayathdate`,
 ...
 `wk_totalattendance`, `wk_perheadwages`, `wk_totalcost` FROM `work`
  ...
  inner join work_employee_allotment on work_employee_allotment.wk_id=work.wk_id 
	and work_employee_allotment.em_id=$em_id order by work.wk_id desc";
...
<body>
    <?php
    $currentmenu="employee-workdetails";
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									<thead>
									  <tr>
										...
										<th>Start Date</th>
										<th>Finish Date</th>
										<th class="text-right">Work Status</th>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right"><b class="text-danger"><?php echo $row1['wk_status']?></b></td>
										...
										<tr>
											...
											<td class="text-white bg-primary text-white"><b></b></td>
											<td class="text-right bg-primary"></td>
											<td class="text-right bg-primary"></td>
											<td class="text-right  bg-primary text-white"><b>Total</b></td>
