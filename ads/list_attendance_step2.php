                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Alloted Employees for Selected Work</strong>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:59px;'>
												...
												if($attendanceflag==0){
												?>
												<a href="sqlprocess/workattendance_sql_process.php?wk_id=<?php echo $wk_id;?>&wa_id=<?php echo $row2['wa_id'];?>&wr_date=<?php echo $wr_date;?>" class="btn btn-sm btn-outline-danger"><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Mark Attenance&nbsp;&nbsp;&nbsp;&nbsp;</a>
												<?php
												}
												else{
												?>
												<a class="btn btn-sm btn-outline-secondary"><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Attenance Marked&nbsp;&nbsp;&nbsp;&nbsp;</a>
												<?php
												}
												?>
											</td>
