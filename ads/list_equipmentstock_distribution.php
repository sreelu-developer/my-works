                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Equipment Stock Distribution</strong>
							</div>
							<div class="card-body">
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
										...
										while($row=mysqli_fetch_array($data)){
											...
											$balanceqty=$totaloutward['total']-$totalinward['total']-$totaldistribution['total'];
										?>
										<tr>
											...
											<td class="text-right"><?php echo $balanceqty;   ?></td>
											<td class="text-right" style='width:149px;'>
												<a href="manage_equipment_distribution.php?eq_id=<?php echo $row['eq_id']?>&balanceqty=<?php echo $balanceqty;?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-sitemap"></i>&nbsp; Distribute to Employess</a>
											</td>
										</tr>
										<?php
										}
