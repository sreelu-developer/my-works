...
DATE_FORMAT(wk_aedate,'%d/%M/%Y' ) AS `wk_aedate`, `wk_aestatus`, `wk_employeeapprovestrength`,
 ...
 where wk_status='approved' and work.ad_id=$ad_id";
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:100px;'>
												<?php if($row1['wk_employeeapprovestrength']-$allotedemployees['totalemployess']>0){ ?>
												<a class="btn btn-sm btn-outline-danger disabled"><i class="fa fa-close"></i>&nbsp; EMPLOYEE ALLOTMENT NOT COMPLETED</a>
												<?php
												}else{
												?>
												<a href="sqlprocess/startwork_sql_process.php?wk_id=<?php echo $row1['wk_id']?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-forward"></i>&nbsp; START WORK</a>
												<?php
												}
												?>
											</td>
