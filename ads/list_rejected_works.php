...
DATE_FORMAT(wk_aedate,'%d/%M/%Y' ) AS `wk_aedate`, `wk_aestatus`, `wk_employeeapprovestrength`,
 ...
 where wk_status='rejected' and work.ad_id=$ad_id";
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">Rejected Work [ <span class="text-danger"> <?php echo $adsdetails['pw_name'].' '.$adsdetails['pw_number']; ?> </span> ]</strong>
							</div>
							<div class="card-body">
