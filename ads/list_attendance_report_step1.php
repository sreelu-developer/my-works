                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								...
								<a href="list_attendance_step1.php" class="btn btn-sm btn-outline-secondary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;Back</a>
							</div>
							<div class="card-body">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:59px;'>
												<a href="list_attendance_report_step2.php?wr_date1=<?php echo $row2['wr_date']; ?>&wr_date=<?php echo $row2['date1']; ?>&wk_id=<?php echo $wk_id; ?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-check-square"></i>&nbsp;Attenance Report on&nbsp; <?php echo $row2['wr_date']; ?></a>
											</td>
										</tr>
										<?php
										}
