...
DATE_FORMAT(wk_aedate,'%d/%M/%Y' ) AS `wk_aedate`, `wk_aestatus`, `wk_employeeapprovestrength`,
 ...
 where ( wk_status='approved' or  wk_status='started' or  wk_status='finished' ) and work.ad_id=$ad_id";
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">Work-Employee Allotment [ <span class="text-danger"> <?php echo $adsdetails['pw_name'].' '.$adsdetails['pw_number']; ?> </span> ]</strong>
							</div>
							<div class="card-body">
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									<thead>
									  <tr>
										...
										<th>Contact</th>
										<th>Apply Date</th>
										<th class="text-right">Approved Strength</th>
										<th class="text-right">Alloted Strength</th>
										<th></th>
									  </tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td class="text-right"><?php echo $row1['wk_employeeapprovestrength']?></td>
											<td class="text-right"><?php echo $allotedemployees['totalemployess']?></td>
											<td class="text-right" style='width:149px;'>
												<?php
												if($row1['wk_status']=="approved"){
												?>
												<a href="list_employee_allotment_step2.php?wk_id=<?php echo $row1['wk_id']?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-users"></i>&nbsp; EMPLOYEE ALLOTMENT</a>
												<?
												}else{
												?>
												<a class="btn btn-sm btn-outline-info disabled"><i class="fa fa-users"></i>&nbsp; WORK STARED</a>
												<?php
												}											
												?>
												<a href="list_employee_alloted.php?wk_id=<?php echo $row1['wk_id']?>" class="btn btn-sm btn-outline-danger"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;ALLOTED EMPLOYEES&nbsp;&nbsp;&nbsp;</a>
											</td>
										</tr>
										<?php
										}
