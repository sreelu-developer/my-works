...
`wk_address`, DATE_FORMAT(wk_startdate,'%d/%M/%Y' ) AS `wk_startdate`,
 ...
 where wk_status!='rejected' and wk_adsstatus='approved' and work.ad_id=$ad_id";
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">Approved Works [ <span class="text-danger"> <?php echo $adsdetails['pw_name'].' '.$adsdetails['pw_number']; ?> </span> ]</strong>
							</div>
							<div class="card-body">
