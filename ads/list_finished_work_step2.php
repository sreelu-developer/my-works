                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Attendance Report of Selected Finished Work</strong>
								<a href="list_finished_work_step1.php" class="btn btn-sm btn-outline-secondary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;Back</a>
							</div>
							<div class="card-body">
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
										...
										$query2="SELECT distinct DATE_FORMAT(wr_date,'%d/%M/%Y' ) AS `wr_date`,wr_date as date1  FROM `work_attendance` where wk_id=$wk_id";
										$data2=DataBase::SelectData($query2);
										while($row2=mysqli_fetch_array($data2)){
											$query2="SELECT count(*) as totalattandance FROM `work_attendance` where wr_date='".$row2['date1']."' and wk_id=$wk_id";
										...
										<tr>
											...
											<td class="text-right" style='width:59px;'>
												<a href="list_finished_work_step3.php?wr_date=<?php echo $row2['date1']; ?>&wk_id=<?php echo $wk_id; ?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-check-square"></i>&nbsp;Attenance Report on&nbsp; <?php echo $row2['wr_date']; ?></a>
											</td>
										</tr>
										<?php
										}
