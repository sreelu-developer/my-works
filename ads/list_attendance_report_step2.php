                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Attendance Report on <?php echo $wr_date1; ?></strong>
								<a href="list_attendance_report_step1.php?wk_id=<?php echo $wk_id; ?>" class="btn btn-sm btn-outline-secondary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;Back</a>
							</div>
							<div class="card-body">
