<?php
include_once('security_check_secretary.php');
...
`wk_address`,DATE_FORMAT(wk_startdate,'%d/%M/%Y' ) AS `wk_startdate`,
 DATE_FORMAT(wk_finishdate,'%d/%M/%Y' ) AS `wk_finishdate`, 
 `wk_status`,DATE_FORMAT(wk_memberapplydate,'%d/%M/%Y' ) AS `wk_memberapplydate`, `wk_contract`, 
...
DATE_FORMAT(wk_panchayathdate,'%d/%M/%Y' ) AS `wk_panchayathdate`,
 `wk_panchayathstatus`,DATE_FORMAT(wk_aedate,'%d/%M/%Y' ) AS `wk_aedate`, `wk_aestatus`, `wk_employeeapprovestrength`,
 ...
 where wk_status!='rejected' and  wk_adsstatus='approved' and wk_panchayathstatus='approved'";
