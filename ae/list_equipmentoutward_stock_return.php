                    ...
                    <div class="col-md-12">
						...
						?>
						  <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
							<span class="badge badge-pill badge-danger">Success</span>
								Outward Stock Sucessfully Returned
						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Return Outward Equipment ( <?php echo $adsdetails['ad_firstname'].", ".$adsdetails['ad_mobilenumber'].", ".$adsdetails['pw_name'].", ".$adsdetails['ad_status']; ?> ) </strong>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:49px;'>
												...
												?>
												<a href="manage_equipmentoutward_ads.php?mode=return&eo_id=<?php echo $row['eo_id']; ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-cart-arrow-down"></i>&nbsp; Return Outward Entry</a>
												<?php
												}
												else{
												?>
