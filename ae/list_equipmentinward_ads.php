                ...
                <div class="row">
					...
					<div class="card">
						<div class="card-header">
							<strong class="card-title">ADS Equipments Inward ( Equipments Recived from ADS )</strong>
						</div>
						<div class="card-body">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-right" style='width:100px;'>
											<a href="list_equipmentoutward_stock_return.php?ad_id=<?php echo $row1['ad_id']?>" class="btn btn-sm btn-outline-danger pull-right"><i class="fa fa-cart-arrow-down"></i>&nbsp;Return Equipment from ADS</a>
											<a href="list_equipmentinward_stock.php?ad_id=<?php echo $row1['ad_id']?>" class="btn btn-sm btn-outline-primary pull-right"><i class="fa fa-cart-arrow-down"></i>&nbsp;Inward Stock Report</a>
										</td>
									</tr>
									<?php
									}
