...
DATE_FORMAT(wk_panchayathdate,'%d/%M/%Y' ) AS `wk_panchayathdate`,
 ...
 where wk_status='new' and  wk_adsstatus='approved' and 
 wk_panchayathstatus='approved' and wk_aestatus='waiting'";
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">New Applied Works</strong>
							</div>
							<div class="card-body">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:143px;'>
												<a href="sql_process/work_approval_sql_process.php?wk_id=<?php echo $row1['wk_id']?>&mode=approved" class="btn btn-sm btn-outline-primary">Approve</a>
												<a href="sql_process/work_approval_sql_process.php?wk_id=<?php echo $row1['wk_id']?>&mode=rejected" class="btn btn-sm btn-outline-danger">Reject</a>
											</td>
										</tr>
										<?php
										}
