...
`wk_address`, `wk_startdate`,
 ...
 where wk_status='new' and work.pw_id=".$memberdetails['pw_id'];
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">New Applied Works on Ward [ <span class="text-danger"> <?php echo $memberdetails['pw_name'].' '.$memberdetails['pw_number']; ?> </span> ]</strong>
							</div>
							<div class="card-body">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right" style='width:159px;'>
												<a href="manage_works.php?wk_id=<?php echo $row1['wk_id']?>&mode=edit" class="btn btn-sm btn-outline-primary"><i class="fa fa-pencil"></i>&nbsp; EDIT</a>
											
												<a href="manage_works.php?wk_id=<?php echo $row1['wk_id']?>&mode=delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-close"></i>&nbsp; DELETE</a>
											</td>
										</tr>
										<?php
										}
