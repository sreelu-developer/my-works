...
`wk_address`, `wk_startdate`,
 ...
 where wk_status='approved' and work.pw_id=".$memberdetails['pw_id'];
...
<body>
    <?php
    $currentmenu="New-Approved-Works";
                ...
                <div class="row">
					...
					<div class="card">
							<div class="card-header">
								<strong class="card-title">Approved and waiting to start works on Ward [ <span class="text-danger"> <?php echo $memberdetails['pw_name'].' '.$memberdetails['pw_number']; ?> </span> ]</strong>
							</div>
							<div class="card-body">
